...
const handleChange = e =>{
  ...
  useEffect(()=>{
  if(user) 
  {   user.role==="admin"?setendpoint("/admin-register-country"):setendpoint("/org-register-country"); 
  }
...
CampusForm.defaultProps = {
  title: "Add Country ambassador details"
};
