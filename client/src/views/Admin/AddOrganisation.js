...
function AddOrganisation({data}) {
    ...
    const [tableitem,settableitem]=useState(["number","email","type","city","state","country","website"].sort());
    ...
    useEffect(()=>{
        ...
        fetch(`/api/users/get-organisation`,{    
        headers:{
    ...
    return (
        <div>
            ...
            <Tables type="org" title="Organisations" users={user} filter={filter}/>
        </div>
    )
}
