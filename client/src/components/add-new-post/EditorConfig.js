...
class ImageBlot extends BlockEmbed {
    ...
    static create(value) {
        ...
        imgTag.setAttribute('style', 'object-fit:fill');
        // style="color:blue;"
        // imgTag.setAttribute('display', 'block');
        // imgTag.setAttribute('margin-left', 'auto');
        // imgTag.setAttribute('margin-right', 'auto');
        // height: 300px;
        // object-fit: contain;
        console.log(imgTag);
        return imgTag;
